<style>
    body {
        background: black url("images/photos/banner.jpg") no-repeat;
...
<html>
    <head><title>HolidayCrown | Manger</title></head>
    <body>
        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data" class="box">
            <h1>Manger Access</h1>
